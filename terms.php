...
?>
    ...
    <section class="section section-bg">
        <div class="container">
            ...
            <h1 style="font-size: 2rem; font-weight: 700;">Terms of Service</h1>
        ...
        <div class="container" style="max-width: 800px;">
            <div style="background: var(--color-bg); border: 1px solid var(--color-border); border-radius: var(--radius-lg); padding: 2rem;">
                ...
                <p style="color: var(--color-text-light); margin-bottom: 1.5rem;">
                    ...
                    <a href="shipping.php" style="color: var(--color-primary);">Shipping Policy</a>.
                </p>
                ...
                <p style="color: var(--color-text-light); margin-bottom: 1.5rem;">
                    ...
                    For complete details, see our <a href="returns.php" style="color: var(--color-primary);">Returns Policy</a>.
                </p>
