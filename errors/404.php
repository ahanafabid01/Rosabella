    ...
    <section class="section" style="min-height: 60vh; display: flex; align-items: center; justify-content: center;">
        <div class="container" style="text-align: center;">
            ...
            <div style="display: flex; gap: 1rem; justify-content: center; flex-wrap: wrap;">
                <a href="/Kartly/" class="btn btn-primary btn-lg">
            ...
            <div style="margin-top: 4rem;">
                ...
                <div style="display: flex; gap: 1rem; justify-content: center; flex-wrap: wrap;">
                    <a href="/Kartly/new-arrivals" class="btn btn-secondary">New Arrivals</a>
                    <a href="/Kartly/best-sellers" class="btn btn-secondary">Best Sellers</a>
                    <a href="/Kartly/sale" class="btn btn-secondary">Sale Items</a>
                    <a href="/Kartly/help" class="btn btn-secondary">Help Center</a>
                </div>
            </div>
        </div>
    </section>
