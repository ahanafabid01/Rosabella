                    ...
                    <div class="form-group">
                        <label style="display: flex; align-items: flex-start; gap: 0.5rem; font-size: 0.875rem; cursor: pointer;">
                            ...
                            <span style="color: var(--color-text-light);">
                                I agree to the <a href="terms.php" style="color: var(--color-primary);">Terms of Service</a> and <a href="privacy.php" style="color: var(--color-primary);">Privacy Policy</a>
                            </span>
                        </label>
                    </div>
