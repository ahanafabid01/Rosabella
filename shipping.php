    ...
    <section class="section section-bg">
        <div class="container">
            <nav style="font-size: 0.875rem; color: var(--color-text-light); margin-bottom: 0.5rem;">
                ...
                <span> / </span>
                <a href="help.php" style="color: var(--color-text-light);">Help</a>
                <span> / </span>
                <span style="color: var(--color-text);">Shipping Info</span>
            </nav>
            <h1 style="font-size: 2rem; font-weight: 700;">Shipping Information</h1>
        </div>
    </section>
        ...
        <div class="container" style="max-width: 900px;">
            ...
            <div style="display: flex; flex-direction: column; gap: 1rem;">
                <details style="background: var(--color-bg); border: 1px solid var(--color-border); border-radius: var(--radius-md); padding: 1rem 1.5rem; cursor: pointer;">
                    ...
                    <p style="margin-top: 0.75rem; color: var(--color-text-light);">Once your order ships, you'll receive an email with tracking information. You can also track your order on our <a href="track-order.php" style="color: var(--color-primary);">Track Order</a> page.</p>
                </details>
                <details style="background: var(--color-bg); border: 1px solid var(--color-border); border-radius: var(--radius-md); padding: 1rem 1.5rem; cursor: pointer;">
