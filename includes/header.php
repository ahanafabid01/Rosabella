...
<head>
    ...
    <!-- Favicon -->
    <link rel="icon" href="/Kartly/assets/images/favicon.ico" type="image/x-icon">
    
    <!-- Stylesheets -->
    <link rel="stylesheet" href="/Kartly/assets/css/style.css">
...
<body>
    ...
    <header class="header">
        ...
        <div class="header-main">
            <div class="header-main-content container">
                ...
                <!-- Logo -->
                <a href="/Kartly/" class="logo">
                    <div class="logo-icon">K</div>
                    <span>KARTLY</span>
                </a>

                <!-- Search Bar (center, desktop) -->
                <form action="/Kartly/search" method="GET" class="header-search-form">
                ...
                <div class="header-actions">
                    ...
                    <!-- Login / Register -->
                    <?php if (isLoggedIn()): ?>
                        <a href="/Kartly/account" class="header-login-link" aria-label="My Account">
                    ...
                    <?php else: ?>
                        <a href="/Kartly/login" class="header-login-link" aria-label="Login or Register">
                            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                                <path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"/><circle cx="12" cy="7" r="4"/>
                            </svg>
                    ...
                    <!-- Wishlist -->
                    <a href="/Kartly/wishlist" class="header-icon-btn header-action-btn" aria-label="Wishlist">
                    ...
                    <!-- Cart -->
                    <a href="/Kartly/cart" class="header-cart-btn header-action-btn" aria-label="Shopping cart">
            ...
            <div class="mobile-search">
                <form action="/Kartly/search" method="GET" class="mobile-search-form">
            ...
            <div class="container">
                <ul class="header-nav-list">
                    <?php foreach ($categories as $category): ?>
                        <li>
                            <a href="/Kartly/category/<?= urlencode($category['slug']) ?>" class="header-nav-link">
    ...
    <nav class="mobile-nav">
        ...
        <ul class="mobile-nav-list">
            <?php foreach ($categories as $category): ?>
                <li>
                    <a href="/Kartly/category/<?= urlencode($category['slug']) ?>" class="mobile-nav-link">
                        <?= htmlspecialchars($category['name']) ?>
