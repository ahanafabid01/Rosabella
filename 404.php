    ...
    <section class="section" style="min-height: 60vh; display: flex; align-items: center; justify-content: center;">
        <div class="container" style="text-align: center;">
            ...
            <div style="margin-top: 4rem;">
                ...
                <div style="display: flex; gap: 1rem; justify-content: center; flex-wrap: wrap;">
                    <a href="products.php?filter=new" class="btn btn-secondary">New Arrivals</a>
                    <a href="products.php?filter=bestseller" class="btn btn-secondary">Best Sellers</a>
                    <a href="products.php?filter=sale" class="btn btn-secondary">Sale Items</a>
