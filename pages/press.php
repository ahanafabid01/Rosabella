...
?>
    ...
    <section style="background: linear-gradient(135deg, var(--color-primary), #dc5603); padding: 4rem 0; color: white; text-align: center;">
        <div class="container">
            <h1 style="font-size: 2.5rem; font-weight: 700; margin-bottom: 1rem;">Press & Media</h1>
            <p style="max-width: 600px; margin: 0 auto; opacity: 0.9;">Latest news and media coverage about KARTLY</p>
        </div>
    </section>
