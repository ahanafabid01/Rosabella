    ...
    <section class="section section-bg" style="padding: 1rem 0;">
        <div class="container">
            <div style="display: flex; flex-direction: column; gap: 0.5rem;">
                <h1 style="font-size: 1.875rem; font-weight: 700;">Careers</h1>
                <nav style="font-size: 0.875rem; color: var(--color-text-light); display: flex; align-items: center; gap: 0.5rem; flex-wrap: wrap;">
                    ...
                    <span>/</span>
                    <span style="color: var(--color-text);">Careers</span>
                </nav>
            </div>
            <p style="color: var(--color-text-light); margin-top: 0.5rem; font-size: 0.875rem;">Be part of something amazing. Build your career with KARTLY.</p>
        </div>
    </section>
