    ...
    <section class="section section-bg" style="padding: 1rem 0;">
        <div class="container">
            <div style="display: flex; flex-direction: column; gap: 0.5rem;">
                <h1 style="font-size: 1.875rem; font-weight: 700;">About Us</h1>
            ...
            <p style="color: var(--color-text-light); margin-top: 0.5rem; font-size: 0.875rem;">From a small startup to your favorite shopping destination</p>
        </div>
    </section>
